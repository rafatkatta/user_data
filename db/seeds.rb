...
account = Account.create!(email: 'admin@example.com', password: 'password', password_confirmation: 'password', is_admin: true) if Rails.env.development?
User.create!(firstname: 'first', lastname: 'admin', gender: Gender.first, account: account)
